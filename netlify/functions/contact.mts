...
// Env vars required (configure in Netlify > Site settings > Environment variables):
//   RESEND_API_KEY  — your Resend API key (starts with "re_")
//   CONTACT_TO      — (optional) destination email, defaults to agencia@ismindai.es
//   CONTACT_FROM    — (optional) verified sender, defaults to "ISMIND.AI <onboarding@resend.dev>"
